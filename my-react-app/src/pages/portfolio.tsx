...
const portfolioData: PortfolioData = {
  ...
  email: "mauryadeepansh40@gmail.com",
  phone: "+91-7719732585",
  location: "India",
  ...
  projects: [
    {
      ...
      description: "Backend-heavy SaaS for real-time user consent tracking across platforms. Includes compliance scanner, event-driven backend, and embeddable SDKs.",
      technologies: ["TypeScript", "Next.js", "Kafka", "Redis", "MongoDB", "Prisma", "Docker"],
      status: "In Progress",
    ...
    },
    {
      ...
      description: "A photo-sharing app where users can upload images with captions, grouped into custom sections. Built with a clean UI and minimal stack.",
      technologies: ["React", "Javascript", "MongoDB", "Node.js", "Tailwind CSS"],
      status: "Live",
      metrics: "not available",
    ...
    },
    {
      ...
      description: "A modern implementation of Conway's Game of Life using Next.js and TypeScript. Focused on rendering efficiency and dynamic grid-based logic with a minimal UI.",
      technologies: ["Next.js", "TypeScript", "CSS"],
      status: "Completed",
      metrics: "Zero-dependency logic with interactive controls",
      live: "https://conway-life-deep.vercel.app",
...
export default function App() {
  ...
  return (
    <div className="min-h-screen p-2 sm:p-4 flex items-center justify-center">
      <div className="w-full max-w-7xl h-screen sm:h-[95vh] crt-screen border-2 sm:border-4 border-crt-gray shadow-2xl">
        {/* Terminal Header */}
        <div className="bg-crt-gray px-2 sm:px-4 py-2 flex items-center justify-between border-b border-crt-gray">
        ...
        <div className="p-2 sm:p-6 h-full flex flex-col">
          ...
          <div className="flex space-x-1 mb-4 sm:mb-6 overflow-x-auto">
            ...
            <TabButton tabName="experience" label="EXP" />
            <TabButton tabName="projects" label="PROJ" />
          ...
          <div className="flex-1 bg-crt-dark border border-crt-gray rounded-lg p-3 sm:p-6 content-area relative overflow-y-auto">
            ...
            {activeTab === "info" && (
              <div className="text-center space-y-4">
                ...
                <div className="terminal-green text-xs sm:text-sm max-w-2xl mx-auto leading-relaxed px-2">
                  {portfolioData.bio}
                </div>
                <div className="flex flex-col sm:flex-row justify-center space-y-2 sm:space-y-0 sm:space-x-8 text-xs terminal-amber mt-6 sm:mt-8">
                    ...
                    >
                      ...
                      <div className="flex flex-wrap gap-1 mb-3">
                        {project.technologies.map((tech, idx) => {
                          ...
                          if (colorClass === 'terminal-cyan') bgClass = 'bg-terminal-cyan';
                          else if (colorClass === 'terminal-amber') bgClass = 'bg-terminal-amber';
                          else if (colorClass === 'terminal-pink') bgClass = 'bg-terminal-pink';
                          
                          return (
                            <span 
                              key={idx} 
                              className={`${bgClass} text-black text-xs px-2 py-1 rounded`}
                            >
                              {tech}
                            </span>
                          );
                      ...
                      <div className="terminal-amber text-xs mb-2">
                        ...
                        <div className="flex space-x-3 text-xs">
                          {project.live && (
                            <a
                              ...
                              className="terminal-cyan hover:text-white transition-colors duration-300 flex items-center space-x-1"
                            >
                          ...
                          {project.code && (
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="terminal-green hover:text-white transition-colors duration-300 flex items-center space-x-1"
                            >
            ...
            {activeTab === "contact" && (
              <div>
                <h2 className="text-lg sm:text-2xl font-bold terminal-cyan mb-6 sm:mb-8 text-center neon-text" style={{marginTop:"10px"}}>
                  GET IN TOUCH
                </h2>
